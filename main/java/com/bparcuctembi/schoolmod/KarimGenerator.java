...
public class KarimGenerator implements IWorldGenerator {
    ...
    (new WorldGenMinable(BaseSchoolMod.karim, 1, 15, Blocks.end_stone)).generate(world, random, Xcoord, Ycoord, Zcoord);
    }

    private void generateOverworld(World world, Random random, int x, int z) 
    {
            this.addOreSpawn(BaseSchoolMod.karim, world, random, x, z, 16, 16, 4 + random.nextInt(3), 10, 15, 50);
    }
    ...
    (new WorldGenMinable(BaseSchoolMod.karim, 1, 15, Blocks.netherrack)).generate(world, random, Xcoord, Ycoord, Zcoord);
    }
